...
import VerifyContract from './SmartContract/VerifyContract'
        ...
        <div className="dashboard-container" style={{filter: showConfirmPassword ? 'blur(7px)' : 'none'}}>
                            ...
                            <Sidenav.Body>
                                <Nav onSelect={setActiveKey} activeKey={activeKey}>
                                    ...
                                    <Dropdown eventKey="smart-contract" icon={<Icon icon="file-code-o" />} title="Smart Contract">
                                        <Dropdown.Item eventKey="source-code-deployment" href="/wallet/smc/source-code-deployment">Verify Contract Source Code</Dropdown.Item>
                                        <Dropdown.Item
            ...
            <div className="right-container" style={isMobile ? { width: '100%' } : {}}>
                ...
                <Switch>
                    ...
                    <AuthRouter component={VerifyContract} path="/wallet/smc/source-code-deployment" />
